...
export default function InicioPeisa(){
    ...
    <div className={c.leftCont}>
     ...
     <div className={`${c.h1} ${c.transform}`}>
        <h1>SERVICE DE CALDERAS <br /> <span className={c.h1Span}>PEISA</span></h1>
     </div>

     <div className={`${c.peisaDiv} ${c.p}`}>

        <p><span>ATENCIÓN INMEDIATA en CABA y Zona Sur.</span> <br /> Reparación, Mantenimiento e Instalación de <span>Calderas PEISA</span> para empresas y hogares. <br /> Servicio técnico especializado en la <span>MARCA PEISA</span> las 24hs. <br /> Soluciona tu problema <span>AHORA</span></p>
